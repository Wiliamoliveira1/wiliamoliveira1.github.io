...
<body>
        ...
        <div class="product-display">
            ...
            <div class="product-info">
                <div class="price-section">
                    ...
                    <div class="price">R$ 25.000,00 <small>à vista</small></div>
                    <p>ou 12x de R$ 2.250,00 sem juros</p>
                </div>
                
                <div class="features-list">
                    <h3>Principais Recursos:</h3>
                    <ul>
                        <li>Alta precisão (0.031 mm por passo)</li>
                        <li>Melt Electrowriting (MEW)</li>
                        <li>Impressão 3D e eletrofiação</li>
                        <li>Interface web integrada</li>
                        <li>Controle via gamepad</li>
                        <li>Open Source (Tobor/FluidNC)</li>
                    </ul>
                </div>
        ...
        <div class="tabs-section">
            ...
            <div id="tab1" class="tab-content active">
                <div class="specs-grid">
                    <div class="spec-item">
                        <h4>Hardware</h4>
                        <p><strong>Microcontrolador:</strong> ESP32 com 4MB SPIRAM</p>
                        <p><strong>Drivers:</strong> 3x DRV8825</p>
                        <p><strong>Encoders:</strong> AS5048B 14 bits</p>
                    </div>
                    <div class="spec-item">
                        <h4>Desempenho</h4>
            ...
            <div id="tab2" class="tab-content">
                ...
                <p>O Biofabricarobot é versátil e pode ser utilizado em diversas aplicações de biofabricação:</p>
            ...
            <div id="tab3" class="tab-content">
                ...
                <p>O Biofabricarobot é baseado em projetos open-source que permitem total customização:</p>
                
                <div class="specs-grid">
                    <div class="spec-item">
                        <h4><i class="fab fa-github"></i> Tobor</h4>
    ...
    <footer>
        <p>© 2023 Biofabricarobot - Todos os direitos reservados</p>
